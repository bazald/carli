...
g_base_command = "./advent --output experiment --print-every 1000 --epsilon-greedy 0.1 --discount-rate 0.9 --eligibility-trace-decay-rate 0.3 --learning-rate 0.1 --secondary-learning-rate 0.1 --policy off-policy --split-update-count 20 --unsplit-update-count 100 --credit-assignment-log-base 1.1"

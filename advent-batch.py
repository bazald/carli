...
#g_ep_tuples.append(("policy-none",        "--split-test policy --unsplit-test none                                                        --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("policy-policy-none", "--split-test policy --unsplit-test policy --resplit-bias none                                  --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("policy-policy-bkls", "--split-test policy --unsplit-test policy --resplit-bias blacklist                             --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("policy-policy-bst",  "--split-test policy --unsplit-test policy --resplit-bias boost                                 --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("policy-policy-c500", "--split-test policy --unsplit-test policy --resplit-bias boost     --concrete-update-count 500 --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
g_ep_tuples.append(("policy-policy-c500-even", "--split-test policy --unsplit-test policy --resplit-bias boost --concrete-update-count 500                                  --rules rules/advent.carli"))

#g_ep_tuples.append(("value-none",         "--split-test value --unsplit-test none                                                         --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("value-value-none",   "--split-test value --unsplit-test value --resplit-bias none                                    --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("value-value-bkls",   "--split-test value --unsplit-test value --resplit-bias blacklist                               --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("value-value-bst",    "--split-test value --unsplit-test value --resplit-bias boost                                   --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("value-value-c500",   "--split-test value --unsplit-test value --resplit-bias boost       --concrete-update-count 500 --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
g_ep_tuples.append(("value-value-c500-even", "--split-test value --unsplit-test value --resplit-bias boost     --concrete-update-count 500                                  --rules rules/advent.carli"))

#g_ep_tuples.append(("catde-none",         "--split-test catde --unsplit-test none                                                         --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("catde-catde-none",   "--split-test catde --unsplit-test catde --resplit-bias none                                    --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("catde-catde-bkls",   "--split-test catde --unsplit-test catde --resplit-bias blacklist                               --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
##g_ep_tuples.append(("catde-catde-bst",    "--split-test catde --unsplit-test catde --resplit-bias boost                                   --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
#g_ep_tuples.append(("catde-catde-c500",   "--split-test catde --unsplit-test catde --resplit-bias boost       --concrete-update-count 500 --credit-assignment-log-base 1.1 --rules rules/advent.carli"))
g_ep_tuples.append(("catde-catde-c500-even", "--split-test catde --unsplit-test catde --resplit-bias boost     --concrete-update-count 500                                  --rules rules/advent.carli"))

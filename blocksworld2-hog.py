...
g_dir = 'experiment-bw2-hog'
g_plotters = ['./blocksworld2.py']
g_error = False

g_base_command = "./blocks_world_2 --output experiment --discount-rate 0.9 --eligibility-trace-decay-rate 0.3 --learning-rate 0.03 --secondary-learning-rate 0.01 --policy off-policy --split-update-count 20 --split-test value --unsplit-test value --unsplit-update-count 50 --resplit-bias boost --concrete-update-count 100 --step-cutoff 100 --bw2-goal exact --rules rules/blocks-world-2-classic-exact.carli"

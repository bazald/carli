...
namespace Cart_Pole {
  ...
  double Environment::prob_push_right(const double &s) {
...
//   }
  ...
  void Environment::cart_pole(int action, float *x, float *x_dot, float *theta, float *theta_dot)
  {
  ...
  int Environment::get_box(float x, float x_dot, float theta, float theta_dot)
  {
    int box=0;

...
int main(int argc, char **argv) {
  ...
  options.add(     std::make_shared<Option_Ranged<int>>("contribute-update-count", 0, true, std::numeric_limits<int>::max(), true), " Require 1 more update than this to count toward means and variances.");

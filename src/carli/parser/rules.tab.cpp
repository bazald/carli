...
static const yytype_uint16 yyrline[] =
{
     ...
     191,   328,   331,   335,   338,   345,   348,   351,   356,   357,
     358,   359,   362,   365,   370,   375,   384,   394,   397,   400,
     401,   404,   405,   406,   407,   410,   411,   414,   417,   418,
     419,   422,   423,   426,   429,   430,   431,   432
};
#endif
...
#line 191 "rules.yyy"
    { const auto &parent = get<0>(*(yyvsp[(2) - (2)].rule_ptr)).first;
                      ...
                      if(node_type.empty()) {
                        ...
                        if(dynamic_cast<Rete::Rete_Join *>(test_node.get())) {

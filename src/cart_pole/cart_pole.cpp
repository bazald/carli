...
int main(int argc, char **argv) {
  try {
    ...
    experiment.standard_run([](){return std::make_shared<Cart_Pole::Environment>();},
                            [](const std::shared_ptr<Carli::Environment> &env){return std::make_shared<Cart_Pole::Agent>(env);},

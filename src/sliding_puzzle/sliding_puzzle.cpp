...
int main(int argc, char **argv) {
  try {
    ...
    experiment.standard_run([](){return std::make_shared<Sliding_Puzzle::Environment>();},
                            [](const std::shared_ptr<Carli::Environment> &env){return std::make_shared<Sliding_Puzzle::Agent>(env);},

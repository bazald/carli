...
g_ep_tuples.append(("exact-value-value-c900-d-35",     "--scenario 35     --skip-steps 0    --bw2-goal exact --learning-rate 0.03 --secondary-learning-rate 0.01 --split-test value --unsplit-test value --split-update-count 30 --unsplit-update-count 100 --resplit-bias boost --concrete-update-count 900 --rules rules/blocks-world-2-distractors-but-not-defective.carli"))
g_ep_tuples.append(("exact-value-value-c900-d-31000",  "--scenario 31000  --skip-steps 1000 --bw2-goal exact --learning-rate 0.03 --secondary-learning-rate 0.01 --split-test value --unsplit-test value --split-update-count 30 --unsplit-update-count 100 --resplit-bias boost --concrete-update-count 900 --rules rules/blocks-world-2-distractors-but-not-defective.carli"))
g_ep_tuples.append(("exact-value-value-c900-d-343000", "--scenario 343000 --skip-steps 3000 --bw2-goal exact --learning-rate 0.03 --secondary-learning-rate 0.01 --split-test value --unsplit-test value --split-update-count 30 --unsplit-update-count 100 --resplit-bias boost --concrete-update-count 900 --rules rules/blocks-world-2-distractors-but-not-defective.carli"))

...
#g_ep_tuples.append(("catde-catde-c500", "--num-blocks 4 --split-test catde --unsplit-test catde --unsplit-update-count 100 --resplit-bias boost     --concrete-update-count 500 --rules rules/blocks-world-2-distractors-but-not-defective.carli"))
...
#g_ep_tuples.append(("value-value-c500", "--num-blocks 4 --split-test value --unsplit-test value --unsplit-update-count 100 --resplit-bias boost     --concrete-update-count 500 --rules rules/blocks-world-2-distractors-but-not-defective.carli"))
...
#g_ep_tuples.append(("policy-policy-c500", "--num-blocks 4 --split-test policy --unsplit-test policy --unsplit-update-count 100 --resplit-bias boost     --concrete-update-count 500 --rules rules/blocks-world-2-distractors-but-not-defective.carli"))
...
#g_ep_tuples.append(("catde-catde-c500-5k", "--num-blocks 4 --split-test catde --unsplit-test catde --unsplit-update-count 100 --resplit-bias boost     --concrete-update-count 500 --rules rules/blocks-world-2-distractors.carli"))
g_ep_tuples.append(("catde-catde-c1000-5k", "--num-blocks 4 --split-test catde --unsplit-test catde --unsplit-update-count 100 --resplit-bias boost     --concrete-update-count 1000 --rules rules/blocks-world-2-distractors.carli"))
...
#g_ep_tuples.append(("value-value-c500-5k", "--num-blocks 4 --split-test value --unsplit-test value --unsplit-update-count 100 --resplit-bias boost     --concrete-update-count 500 --rules rules/blocks-world-2-distractors.carli"))
g_ep_tuples.append(("value-value-c1000-5k", "--num-blocks 4 --split-test value --unsplit-test value --unsplit-update-count 100 --resplit-bias boost     --concrete-update-count 1000 --rules rules/blocks-world-2-distractors.carli"))
...
#g_ep_tuples.append(("policy-policy-c500-5k", "--num-blocks 4 --split-test policy --unsplit-test policy --unsplit-update-count 100 --resplit-bias boost     --concrete-update-count 500 --rules rules/blocks-world-2-distractors.carli"))
g_ep_tuples.append(("policy-policy-c1000-5k", "--num-blocks 4 --split-test policy --unsplit-test policy --unsplit-update-count 100 --resplit-bias boost     --concrete-update-count 1000 --rules rules/blocks-world-2-distractors.carli"))

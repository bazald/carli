...
g_base_command = "./puddle_world --output experiment --random-start true --eligibility-trace-decay-rate 0.3 --discount-rate 0.999 --learning-rate 0.1 --secondary-learning-rate 0.1 --epsilon-greedy 0.1 --policy off-policy --pseudoepisode-threshold 20"
...
g_ep_tuples.append(("even_2x2_64x64_3", "--credit-assignment even --split-min 3 --split-max 13 --value-function-map-mode out"))
...
#g_ep_tuples.append(("even_2x2_64x64_4", "--credit-assignment even --split-min 3 --split-max 13 --value-function-map-mode in"))
...
for ep_tuple in g_ep_tuples:
  ...
  for seed in seeds:
    ...
    vfm = dir + '/puddleworld-' + str(seed) + '.vfm'

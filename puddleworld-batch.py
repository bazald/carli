...
g_ep_tuples.append(('puddle-world', 0, 'specific',              0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 0, 0))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  5,  5, 0, 0.5, 0, 0, 0))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 0, 0))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 0, 0))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 11, 11, 0, 0.5, 0, 0, 0))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 13, 13, 0, 0.5, 0, 0, 0))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 0, 0))
g_ep_tuples.append(('puddle-world', 0, 'specific',              0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 1, 1))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  5,  5, 0, 0.5, 0, 1, 1))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 1, 1))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 1, 1))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 11, 11, 0, 0.5, 0, 1, 1))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 13, 13, 0, 0.5, 0, 1, 1))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 1, 1))
g_ep_tuples.append(('puddle-world', 0, 'specific',              0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 2, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  5,  5, 0, 0.5, 0, 2, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 2, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 2, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 11, 11, 0, 0.5, 0, 2, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 13, 13, 0, 0.5, 0, 2, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 2, 25000))
g_ep_tuples.append(('puddle-world', 0, 'specific',              0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 3, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  5,  5, 0, 0.5, 0, 3, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 3, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 3, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 11, 11, 0, 0.5, 0, 3, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 13, 13, 0, 0.5, 0, 3, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 3, 75000))
g_ep_tuples.append(('puddle-world', 0, 'specific',              0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 4, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  5,  5, 0, 0.5, 0, 4, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 4, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 4, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 11, 11, 0, 0.5, 0, 4, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 13, 13, 0, 0.5, 0, 4, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 4, 125000))
g_ep_tuples.append(('puddle-world', 0, 'specific',              0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 5, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  5,  5, 0, 0.5, 0, 5, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 5, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 5, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 11, 11, 0, 0.5, 0, 5, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 13, 13, 0, 0.5, 0, 5, 25000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 5, 25000))
g_ep_tuples.append(('puddle-world', 0, 'specific',              0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 6, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  5,  5, 0, 0.5, 0, 6, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 6, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 6, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 11, 11, 0, 0.5, 0, 6, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 13, 13, 0, 0.5, 0, 6, 75000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 6, 75000))
g_ep_tuples.append(('puddle-world', 0, 'specific',              0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 7, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  5,  5, 0, 0.5, 0, 7, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  7,  7, 0, 0.5, 0, 7, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 7, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 11, 11, 0, 0.5, 0, 7, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20, 13, 13, 0, 0.5, 0, 7, 125000))
g_ep_tuples.append(('puddle-world', 0, 'inv-root-update-count', 0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 7, 125000))

#g_ep_tuples.append(('puddle-world', 0, 'even',                  0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 3, 75000))
#g_ep_tuples.append(('puddle-world', 0, 'inv-log-update-count',  0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 3, 75000))
#g_ep_tuples.append(('puddle-world', 0, 'epsilon-even-depth',    0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  9,  9, 0, 0.5, 0, 3, 75000))
#g_ep_tuples.append(('puddle-world', 0, 'even',                  0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 3, 75000))
#g_ep_tuples.append(('puddle-world', 0, 'inv-log-update-count',  0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 3, 75000))
#g_ep_tuples.append(('puddle-world', 0, 'epsilon-even-depth',    0.5, 1.0, 0, 0.1, 0.2, 'off-policy', 20,  3, 13, 0, 0.5, 0, 3, 75000))
